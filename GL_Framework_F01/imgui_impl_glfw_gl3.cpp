...
// GL3W/GLFW
#include <glad/glad1_4.6_withLoader.h>    // This example is using gl3w to access OpenGL functions (because it is small). You may use glew/glad/glLoadGen/etc. whatever already works for you.
#include <GL/glfw3.h>
#ifdef _WIN32
#undef APIENTRY
